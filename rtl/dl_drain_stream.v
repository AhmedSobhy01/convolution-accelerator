...
module dl_drain_stream #(
  ...
  wire [ADDR_W-1:0] sram_addr_calc = read_col * {5'b0, cfg_output_dim} + {5'b0, read_row};
  ...
  always @(*) begin
    ...
    if (cfg_split_mode) begin
      sum_temp = {2'b0, sram_rdata[7:0]} + {2'b0, sram_rdata[15:8]} + {2'b0, sram_rdata[23:16]} + {2'b0, sram_rdata[31:24]};
